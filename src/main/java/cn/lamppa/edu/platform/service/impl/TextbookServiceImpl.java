...
import cn.lamppa.edu.platform.dao.ChapterSectionDao;
import cn.lamppa.edu.platform.dao.CommonDao;
import cn.lamppa.edu.platform.dao.TextbookDao;
...
import cn.lamppa.edu.platform.service.ChapterSectionService;
import cn.lamppa.edu.platform.service.TextbookService;
    ...
    public String transferData(List<Textbook> list) {
        ...
        try{
            for(Textbook book:list){
                ...
                String fasciculeId = getFasciculeId(book.getFasciculeName(),gradeId,subjects_id,phases_id,textbookVersionId);
